...
public class AlgumaParser extends Parser {
	...
	public static final int
		...
		T__45=46, T__46=47, T__47=48, PALAVRAS_CHAVES=49, OPERADORES_LOGICOS=50, 
		OPERADORES_ARITMETICOS=51, OPERADORES_RELACIONAIS=52, NUM_INT=53, NUM_REAL=54, 
		IDENT=55, DELIM=56, ABRE_PAR=57, FECHA_PAR=58, ABRE_COL=59, FECHA_COL=60, 
		VIRG=61, ATRIBUICAO=62, PONTEIRO=63, ENDERECO=64, DOT=65, ATE=66, WS=67, 
		CADEIA=68, CADEIA_SEM_FIM=69, COMENTARIO=70, COMENTARIO_SEM_FIM=71, CARACTER_INVALIDO=72;
	public static final int
	...
	private static String[] makeSymbolicNames() {
		return new String[] {
			...
			null, null, null, null, null, null, null, null, null, null, null, null, 
			null, null, null, null, null, null, null, null, null, null, null, null, 
			null, "PALAVRAS_CHAVES", "OPERADORES_LOGICOS", "OPERADORES_ARITMETICOS", 
			"OPERADORES_RELACIONAIS", "NUM_INT", "NUM_REAL", "IDENT", "DELIM", "ABRE_PAR", 
			"FECHA_PAR", "ABRE_COL", "FECHA_COL", "VIRG", "ATRIBUICAO", "PONTEIRO", 
			"ENDERECO", "DOT", "ATE", "WS", "CADEIA", "CADEIA_SEM_FIM", "COMENTARIO", 
	...
	public final Valor_constanteContext valor_constante() throws RecognitionException {
		...
		try {
			...
			setState(176);
			_la = _input.LA(1);
			if ( !((((_la - 11)) & ~0x3f) == 0 && ((1L << (_la - 11)) & 144128382215389187L) != 0) ) {
			_errHandler.recoverInline(this);
			}
			else {
				if ( _input.LA(1)==Token.EOF ) matchedEOF = true;
	...
	public final Declaracao_globalContext declaracao_global() throws RecognitionException {
		...
		try {
			...
			case T__14:
				...
				_errHandler.sync(this);
				_la = _input.LA(1);
				while (((_la) & ~0x3f) == 0 && ((1L << _la) & -9187343194127335424L) != 0) {
					{
					{
					setState(200);
					cmd();
